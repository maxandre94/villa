...
<head>
    ...
    <title>Villa blanca | loisirs</title>
...
<body>
    ...
    <?php if (isset($_GET['lang']) && $_GET['lang'] == "en") { ?>
        ...
        <div class="wrapper">
            ...
            <div class="header-section about-us" style="background: url(images/bg/piscineok.gif)  right no-repeat, url(images/bg/bateauok.gif)  left no-repeat; background-size: 50% 100%;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-title mb-50">
                                <h3 style="font-family: 'Reggae One', cursive;">Pleasure, relaxation & discovery</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <p style="font-size: 20px; font-family:Crimson Pro, serif; line-height: 1.6; text-align: justify;">
                            "Villa BLANCA" <span style="text-transform: lowercase;">
                                Our frame in Assinie also has various relaxation games for a good stay of his
                                customer base.</span>
                        </p>
                    </div>
                </div>
                <!--Our services start-->
                <div class="our-sevices elements text-center pt-30 pb-80 white_bg">
                            ...
                            <div class="row">
                                <div class="col-md-12 pb-80">
                                    <div class="news-inner">
                                        <div class="news-img">
                                            <img src="images/loisir/piscine1.jpg" style="width: 400px; height: 250px;" alt="">
                                            <!-- <div class="news-post">
                                        ...
                                        <div class="news-desc">
                                            <h3 class="news-title"><a href="#">Pool.</a> </h3>
                                            <p class="news_desc">&nbsp;</p>
                                            <div class="news-action">
                                                <div class="read-more">
                                                    <a href="tel:+2250709660606">Book</a>
                                                </div>
                                ...
                                <div class="col-md-12 pb-80">
                                    <div class="news-inner">
                                        <div class="news-img">
                                            <img src="images/loisir/bateau.jpg" style="width: 400px; height: 250px;" alt="">
                                            <!-- <div class="news-post">
                                        <div class="n-date">15 June 2015</div>
                                        <a href="#" class="comment"><span><i class="mdi mdi-comment-processing-outline"></i></span> 20</a>
                                        <div class="news-views">
                                        ...
                                        <div class="news-desc">
                                            <h3 class="news-title"><a href="#">boat for the crossing</a> </h3>
                                            <p class="news_desc">&nbsp;</p>
                                            <div class="news-action">
                                                <div class="read-more">
                                                    <a href="tel:+2250709660606">Book</a>
                                ...
                                <div class="col-md-12 pb-80">
                                    <div class="news-inner">
                                        <div class="news-img">
                                            <img src="images/loisir/jetski.jpeg" style="width: 400px; height: 250px;" alt="">
                                        ...
                                        <div class="news-desc">
                                            <h3 class="news-title"><a href="#">Jet ski</a> </h3>
                                            <p class="news_desc">&nbsp;</p>
                                            <div class="news-action">
                                                <div class="read-more">
                                                    <a href="tel:+2250709660606">Book</a>
                                ...
                                <div class="col-md-12 pb-80">
                                    <div class="news-inner">
                                        <div class="news-img">
                                            <img src="images/loisir/voley.jpg" style="width: 400px; height: 250px;" alt="">
                                            <!-- <div class="news-post">
                                                                <div class="n-date">15 June 2015</div>
                                                                <a href="#" class="comment"><span><i class="mdi mdi-comment-processing-outline"></i></span> 20</a>
                                                                <div class="news-views">
                                        ...
                                        <div class="news-desc">
                                            <h3 class="news-title"><a href="#">Voleyball</a> </h3>
                                            <p class="news_desc">&nbsp;</p>
                                            <div class="news-action">
                                                <div class="read-more">
                                                    <a href="tel:+2250709660606">Book</a>
            ...
            <div class="elements pt-80 text-center white_bg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-title mb-50">
                                <h3 style="font-family: 'Reggae One', cursive;">Plaisir, détente & découvertes</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <p style="font-size: 20px; font-family:Crimson Pro, serif; line-height: 1.6; text-align: justify;">
                            "Villa BLANCA" <span style="text-transform: lowercase;">
                                Notre cadre à Assinie dispose également de divers jeux de détente pour un bon séjour de sa
                                clientèle.</span>
                        </p>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 pb-80">
                                    <div class="news-inner">
                                        ...
                                        <div class="news-desc">
                                            <h3 class="news-title"><a href="#">Piscine.</a> </h3>
                                            <p class="news_desc">&nbsp;</p>
                                            <div class="news-action">
                                                <div class="read-more">
                                                    <a href="tel:+2250709660606">Reservez</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 pb-80">
                                    <div class="news-inner">
                                        ...
                                        <div class="news-desc">
                                            <h3 class="news-title"><a href="#">bateau pour la traversée</a> </h3>
                                            <p class="news_desc">&nbsp;</p>
                                            <div class="news-action">
                                                <div class="read-more">
                                                    <a href="tel:+2250709660606">Reservez</a>
