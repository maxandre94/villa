...
<head>
    ...
    <title>Villa blanca | Chambres</title>
...
<body>
    ...
    <?php if (isset($_GET['lang']) && $_GET['lang'] == "en") { ?>
        ...
        <div class="wrapper">
            ...
            <div class="header-section about-us" style="background: url(images/bg/chambre1ok.gif)  right no-repeat, url(images/bg/chambre2ok.gif)  left no-repeat; background-size: 50% 100%;">
                                    ...
                                    <div class="col-md-10 col-sm-10 hidden-xs">
                                        <div class="header-top ptb-10">
                                            <div class="adresses">
                                                ...
                                                <div class="email">
                                                    <p><a style="text-transform: none; color:white;" href="mailto:reservation@villablanca.ci">Email:
                                                            reservation@villablanca.ci</a></p>
                                                </div>
                            ...
                            <div class="col-md-12">
                                <nav id="dropdown">
                                    <ul>
                                        ...
                                        <li><a href="chambres.php?lang=en">Rooms</a></li>
                                        <li><a href="seminaires.php?lang=en">Séminars</a></li>
                                        <li><a href="resto.php?lang=en">Restaurant</a></li>
                                        <li><a href="loisirs.php?lang=en">Hobbies</a></li>
                                        <!--Header section accueil
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-title mb-75">
                                <h3 style="font-family: 'Reggae One', cursive;">Rooms and suites like you desire</span></h3>
                        ...
                        <div class="row">
                            <div class="carousel-list">
                                ...
                                <div class="col-md-4">
                                    <div class="single-room">
                                        <div class="room-img">
                                            <a href="#"><img src="images/room/room5.jpg" style="width: 370px; height: 256px;" alt=""></a>
                                        </div>
                                        <div class="room-desc">
                                            <div class="room-name">
                                                <h3><a href="#">Suite </a></h3>
                                            ...
                                            <div class="room-rent">
                                                <h5>80 000 fcfa / <span>on working days</span></h5>
                                            </div>
                                            <!--
                                                                                                                <div class="room-book">
                                                                                                                    <a href="#">RESERVEZ</a>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="single-room">
                                        <div class="room-img">
                                            <a href="#"><img src="images/room/room6.jpeg" style="width: 370px; height: 256px;" alt=""></a>
                                        </div>
                                        <div class="room-desc">
                                            <div class="room-name">
                                                <h3><a href="#">Classic room </a></h3>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="single-footer mt-0">
                            ...
                            <div class="hotel-contact">
                                <p><span>Phone:</span> +225 07 09 66 06 06</p>
                                <p><span>Email:</span> reservation@villablanca.ci</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10 col-sm-10 hidden-xs">
                                        <div class="header-top ptb-10">
                                            <div class="adresses">
                                                <div class="phone">
                                                    <p><a style="text-transform: none; color:white;" href="tel:+2250709660606">Téléphone: +225 07 09 66 06
                                                            06</a></p>
                                                </div>
                                                <div class="email">
                                                    <p><a style="text-transform: none; color:white;" href="mailto:reservation@villablanca.ci">Email:
                                            ...
                                            <div class="menu-list hidden-sm hidden-xs">
                                                <nav>
                                                    <ul>
                                                        ...
                                                        <li><a href="seminaires.php">Séminaires</a></li>
                                                        <li><a href="resto.php">Restaurant</a></li>
                                                        <li><a href="loisirs.php">Nos loisirs</a></li>
                                                        <!--Header section reste du menu
                                                                                                                            <li><a href="gallery-2.html">Gallery</a></li>
                                                                                                                            <li><a href="#">pages<i class="fa fa-angle-down"></i></a>
                                                                                                                                <ul class="dropdown_menu">
            ...
            <div class="room-section text-center ptb-80 white_bg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-title mb-75">
                                <h3 style="font-family: 'Reggae One', cursive;">Des chambres et des suites faites à votre goût</span></h3>
                                <!--<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered by injected humour.</p>-->
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="single-footer mt-0">
                            ...
                            <div class="hotel-contact">
                                <p><span>Téléphone:</span> +225 07 09 66 06 06</p>
                                <p><span>Email:</span> reservation@villablanca.ci</p>
                            </div>
                        </div>
                    </div>
