                                                    ...
                                                    <!--Header section accueil
                                                                                                                            <li><a href="#">Accueil</a>
                                                                                                                                <ul class="">
                                                                                                                                    ...
                                                                                                                                    <li><a href="../presentation">Home default</a></li>
                        ...
                        <div class="feature-desc text-left">
                            ...
                            <div class="feature-item">
                                <div class="btn-group" role="group" aria-label="button group">
                                    <a href="menuresto\menu./" role="button" class="btn btn-danger"><i class="fa fa-cutlery" aria-hidden="true"></i> Voir la carte</a>
                        ...
                        <div class="feature-img-tab">
                            ...
                            <div class="feature-tab-item">
                                <ul class="nav" role="tablist">
                                    <li class="active">
                                        <a href="#feature1" data-toggle="tab"><img src="../images/resto/resto1.jpg" style="width: 166px; height: 147px;" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="#feature2" data-toggle="tab"><img src="../images/resto/resto2.jpg" style="width: 166px; height: 147px;" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="#feature3" data-toggle="tab"><img src="../images/resto/resto5.jpeg" style="width: 166px; height: 147px;" alt=""></a>
                                    </li>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="feature-desc text-left">
                            ...
                            <div class="feature-item">
                                <div class="btn-group" role="group" aria-label="button group">
                                    <a href="#" role="button" class="btn btn-danger"><i class="fa fa-cutlery"
                                            aria-hidden="true"></i> Voir la carte</a>
                                    <a href="tel:+2250709660606" role="button" class="btn btn-success"><i class="fa fa-phone"
                                            aria-hidden="true"></i> Reservez</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="feature-img-tab">
                            ...
                            <div class="feature-tab-item">
                                <ul class="nav" role="tablist">
                                    <li class="active">
                                        <a href="#feature3" data-toggle="tab"><img src="../images/resto/resto3.jpeg" style="width: 166px; height: 147px;" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="#feature4" data-toggle="tab"><img src="../images/resto/resto4.jpeg" style="width: 166px; height: 147px;" alt=""></a>
                                    </li>
