...
<head>
    ...
    <title>Villa Blanca | Séminaires</title>
...
<body>
    ...
    <?php if (isset($_GET['lang']) && $_GET['lang'] == "en") { ?>
        ...
        <div class="wrapper">
            ...
            <div class="header-section about-us" style="background: url(images/bg/semin1.gif)  right no-repeat, url(images/bg/semin2.gif)  left no-repeat; background-size: 50% 100%;">
                                ...
                                <div class="row">
                                    <div class="col-md-2 col-sm-2 col-xs-12">
                                        <div class="logo mt-15">
                                            <a href="index.php?lang=en"><img src="images/logo/logo.png" alt=""></a>
                                        </div>
                                    </div>
                                    <div class="col-md-10 col-sm-10 hidden-xs">
                                        <div class="header-top ptb-10">
                                            <div class="adresses">
                                                ...
                                                <div class="input-group  my-2 my-lg-0" style="width: 120px;  position: absolute; top: 0px; right: 0px;">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" style="background: transparent; border: 0px;" id="exampleAddon">

                                                            <img id="tongs_img" src="images/english_icon.png" alt="" style="width: 24px;"></span>
                                                    ...
                                                    <select name="" id="tongs" style="background: rgb(226, 29, 29); color: white; " class="form-control" aria-describedby="exampleAddon">
                                                        <option style="color: black;" selected value="?lang=en">English</option>
                                                        <option style="color: black;" value="?lang=fr">Français</option>
                                            ...
                                            <div class="menu-list hidden-sm hidden-xs">
                                                <nav>
                                                    <ul>
                                                        ...
                                                        <li><a href="resto.php?lang=en">Restaurant</a></li>
                                                        <li><a href="loisirs.php?lang=en">Hobbies</a></li>
            ...
            <div class="Gallery-section text-center ptb-80 white_bg">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-title mb-80">
                                <h1 style="font-family: 'Reggae One', cursive;">Your seminar in Assinie</h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <p style="font-size: 20px; font-family:Crimson Pro, serif; line-height: 1.6; text-align: justify;">
                            "VILLA BLANCA" <span style="text-transform: lowercase;"> space to contain your business and work time the villa blanca also has a large
                                meeting room with a capacity of 200 people and two outdoor restaurants that can accommodate up to 1000
                                people. </span>
                        </p>
                    </div>
                    <div class="our-gallery-show pt-30">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card bg-dark text-white">
                                    <!--tips: add .text-center,.text-right to the .card to change card text alignment-->
                                    <img src="images/semin/salle1.jpg" class="card-img-top" alt="...">

                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="single-gallery-img">
                                    <a href="images/semin/salle1.jpg"><img src="images/semin/salle1.jpg" alt=""></a>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="single-gallery-img">
                                    <a href="images/semin/salle2.jpg"><img src="images/semin/salle2.jpg" alt=""></a>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 hidden-xs">
                                <div class="single-gallery-img">
                                    <a href="images/semin/salle3.jpeg"><img src="images/semin/salle3.jpeg" alt=""></a>
                                </div>
                            </div>
                            <!--<div class="col-md-12">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero cumque ea non quidem iusto rem nesciunt, totam fugit, cupiditate inventore deleniti, consequuntur eius sunt quos eum. Ea, autem nisi! Nihil.
                        </div>-->
                ...
                <div class="container ptb-40">
                    <div class="row">
                        <div class="col-md-12">
                            <a data-toggle="collapse" href="#myCollapse" role="button" class="btn btn-outline-danger" style="background: rgb(226, 29, 29); font-size: 22px; color: white;">Demande un devis</a>
                        </div>
                        <div class="collapse ptb-80" id="myCollapse">
                                                    ...
                                                    <form id="contact-form" role="form">
                                                        <div class="controls">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-7">
                                                                    <div class="form-group"> <label for="form_lastname">Enterprise *</label> <input id="form_lastname" type="text" name="surname" class="form-control" placeholder="Please enter your lastname *" required="required" data-error="Lastname is required."> </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-7">
                                                                    <div class="form-group"> <label for="form_email">Phone *</label> <input id="form_email" type="text" name="email" class="form-control" placeholder="Please enter your email *" required="required" data-error="Valid email is required."> </div>
                                                                </div>
                                                                <div class="col-md-7">
                                                                    <div class="form-group"> <label for="form_need">Number of participants * </label>

                                                                        <input type="number" class="form-control" id="exampleInput" placeholder="Example input placeholder">

                                                                    </div>
                                                                </div>
                                                                <div class="col-md-7">
                                                                    <div class="form-group"> <label for="form_need">Seminar start date * </label>
                                                                ...
                                                                <div class="col-md-7">
                                                                    <div class="form-group"> <label for="form_need">Date fin séminaires * </label>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-7"> <input type="submit" class="btn btn-danger btn-send pt-5 btn-block " value="Send your request">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                                ...
                                                <div class="input-group  my-2 my-lg-0" style="width: 120px;  position: absolute; top: 0px; right: 0px;">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" style="background: transparent; border: 0px;" id="exampleAddon">
                                                            ...
                                                            <img id="tongs_img" src="images/french_icon.png" alt="" style="width: 24px;"></span>
                                                    ...
                                                    <select name="" id="tongs" style="background: rgb(226, 29, 29); color: white; " class="form-control" aria-describedby="exampleAddon">
                                                        <option style="color: black;" value="?lang=en">English</option>
                                                        <option style="color: black;" selected value="?lang=fr">Français</option>
                                            ...
                                            <div class="menu-list hidden-sm hidden-xs">
                                                <nav>
                                                    <ul>
                                                        ...
                                                        <li><a href="seminaires.php">Seminaires</a></li>
            ...
            <div class="Gallery-section text-center ptb-80 white_bg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-title mb-80">
                                <h1 style="font-family: 'Reggae One', cursive;">Votre séminaire à Assinie</h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <p style="font-size: 20px; font-family:Crimson Pro, serif; line-height: 1.6; text-align: justify;">
                            "VILLA BLANCA" <span style="text-transform: lowercase;"> espace pour contenir vos temps d’affaire et de travail la villa blanca dispose également d’une grande
                                salle de réunion d’une capacité de 200 personnes et de deux restaurants plein air qui peuvent recevoir jusqu'à 1000
                                personnes. </span>
                        </p>
                    </div>
                    <div class="our-gallery-show pt-30">
                                                ...
                                                <div class="container">
                                                    <form id="contact-form" role="form">
                                                        <div class="controls">
                                                            <div class="row">
                                                                <div class="col-md-7 align-content-center">
                                                                    <div class="form-group"> <label for="form_name">Nom *</label> <input id="form_name" type="text" name="name" class="form-control" placeholder="Please enter your firstname *" required="required" data-error="Firstname is required."> </div>
                                                                </div>
                                                                <div class="col-md-7">
                                                                    <div class="form-group"> <label for="form_lastname">Entreprise *</label> <input id="form_lastname" type="text" name="surname" class="form-control" placeholder="Please enter your lastname *" required="required" data-error="Lastname is required."> </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-7">
                                                                    <div class="form-group"> <label for="form_email">Téléphone *</label> <input id="form_email" type="text" name="email" class="form-control" placeholder="Please enter your email *" required="required" data-error="Valid email is required."> </div>
                                                                </div>
                                                                <div class="col-md-7">
                                                                    <div class="form-group"> <label for="form_need">Nombre de participants * </label>
                                                                ...
                                                                <div class="col-md-7">
                                                                    <div class="form-group"> <label for="form_need">Date début séminaires * </label>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-7"> <input type="submit" class="btn btn-danger btn-send pt-5 btn-block " value="Envoyer votre démande">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tongs').change(function() {


                var linku = $('#tongs option:selected').val();

                window.open(linku, "_self")
