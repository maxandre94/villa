...
$_resa = $_SESSION['resa'];
 $resa_ligne = ['index' => $index, 'arrive' => $_arrive, 'depart' => $_depart, 'chb_id' => $_chb_type, 'chb_nom' => $_chb_nom, 'chb_sem' => $_chb_sem, 'chb_week' => $_chb_week, 'chb_nb' => $_chb_nb, 'pers_nb' => $_pers_nb];
...
header('Location:../reservation/index.php#section1');
