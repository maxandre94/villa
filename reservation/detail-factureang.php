...
customer(s) : '.$pers.'<span style="margin-left: 150px;"> Total</span></td>
                            ...
                            <center>
                                <?php if (isset($_SESSION['utilisateur'])) {
                                echo '<form action="enregistreDetailFactang.php" method="post" id="formulaire" name="formulaire"><input type="submit" class="btn btn-success" style="width:160px;height: 34px;" name="reserver" value="Reserve"></form>';
                            } else {
