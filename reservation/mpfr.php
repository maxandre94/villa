...
<head>
    ...
    <title>Villa blanca | Réinitialisation mot de passe</title>
        ...
        case 'password':
            ?>
                                <div class="alert alert-danger">
                                    <strong>Erreur</strong> mot de passe non conforme
                                </div>
                                <?php
break;
...
?>
                                <form action="mpfrtraitement.php" method="post">
                                    <h2 class="text-center">Réinitialiser mot de passe</h2>
