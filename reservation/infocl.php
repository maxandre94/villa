                        ...
                        <div class="col-md-12">
                            <div class="booking-rooms-tab text-left">
                                <ul class="nav" role="tablist">
                                    <li><a href="../reservation" data-toggle="tab"><span class="tab-border">1</span><span>Infos chambres</span></a></li>
                                    <li><a href="../reservation/detail-facture.php" data-toggle="tab"><span class="tab-border">2</span><span>Détails facture</span></a>
                                    </li>
                                    <li class="active"><a href="../reservation/infocl.php" data-toggle="tab" name="section3"><span class="tab-border">3</span><span>Infos
                                                client(s)</span></a>
                                    </li>
