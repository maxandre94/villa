...
VALUES ('$id_fact','$id_cl', '$id_typ', '$arrive', '$depart', '$chb_nb', '$pers_nb', '$prix_resa')";
        ...
        if($row > 0){
                                            ...
                                            header('Location: infoclang.php?reg_err=tel');
                                            die();
                                        }
                                    } else {
                                        header('Location: infoclang.php?reg_err=pay_length');
                                        die();
                                    }
                                } else {
                                    header('Location: infoclang.php?reg_err=cp_length');
                                    die();
                                }
                            } else {
                                header('Location: infoclang.php?reg_err=ville_length');
                                die();
                            }
                        } else {
                            header('Location: infoclang.php?reg_err=etat_length');
                            die();
                        }
                    } else {
                        header('Location: infoclang.php?reg_err=adress_length');
                        die();
                    }
                } else {
