                                        ...
                                        <div class="menu-list hidden-sm hidden-xs">
                                            <nav>
                                                <ul>
                                                    ...
                                                    <li><a href="reserv3.php" class="btn btn-danger">Reservation</a>
                                                    </li>
                                                </ul>
                                            </nav>
                                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="booking-rooms-tab text-left">
                                <ul class="nav" role="tablist">
                                    <li><a href="/villa/detail.php" data-toggle="tab" name="section1"><span
                                                class="tab-border">1</span><span>Infos chambres</span></a></li>
                                    <li><a href="/villa/detail-facture.php" data-toggle="tab" name="section2"><span
                                                class="tab-border">2</span><span>Détails facture</span></a>
                                    </li>
                                    <li class="active"><a href="/villa/infocl.php" data-toggle="tab"
                                            name="section3"><span class="tab-border">3</span><span>Infos
                                                client(s)</span></a>
                                    </li>
                                    <li><a href="#payment" data-toggle="tab"><span
                                                class="tab-border">4</span><span>règlement</span></a>
                                    </li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-title mb-50">
                                        ...
                                        <h3 style="font-family: 'Reggae One', cursive;">Connection</h3>

                                    </div>
                                </div>
                            </div>
                            <form name="myForm" method="post" action="resev.php" onsubmit="return validateForm()">
                                <div class="row">

                                    <div class="col-sm-4">

                                        <input type="text" class="form-control" name="mail"
                                            placeholder="Saisir votre Email" onfocus="return validateForm()" /><span
                                            class="error" id="errormail"></span>
                                    ...
                                    <div class="col-sm-5">
                                        <input type="password" class="form-control" name="mp"
                                            ...
                                            onfocus="return validateForm();" /><span class="error" id="errormp"></span>
                                    </div>


                                    <div class="col-sm-2">

                                        <input type="submit" class="btn btn-primary btn-lg" name="ok" value="ENVOYER" />
                                    </div>
