                            ...
                            <div class="carousel-list">
                                <div class="col-md-4">
                                    <div class="single-room">
                                        <div class="room-img">
                                            <a href="#" data-toggle="modal" data-target="#roovilla"><img src="images/room/room1.jpg" style="width: 370px; height: 256px;" alt=""></a>
                                        </div>
                                        <div class="room-desc">
                                            <div class="room-name">
        ...
        <div class="wrapper">
                                    ...
                                    <div class="col-md-10 col-sm-10 hidden-xs">
                                        <div class="header-top ptb-10">
                                            <div class="adresses">
                                                ...
                                                <div class="input-group  my-2 my-lg-0" style="width: 120px;  position: absolute; top: 0px; right: 0px;">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" style="background: transparent; border: 0px;" id="exampleAddon"><img id="tongs_img" src="images/french_icon.png" alt="" style="width: 24px;"></span>
                                                    </div>
                        ...
                        <div class="row">
                            <div class="carousel-list">
                                <div class="col-md-4">
                                    <div class="single-room">
                                        <div class="room-img">
                                            <a href="/detail.php" data-toggle="modal" data-target="#roovilla"><img src="images/room/room1.jpg" style="width: 370px; height: 256px;" alt=""></a>
                                        </div>
                                        <div class="room-desc">
                                            <div class="room-name">
                                                <h3><a href="/detail.php" data-toggle="modal" data-target="#roovilla">Villa famille </a></h3>
                                            </div>
                                            <div class="room-rent">
                                ...
                                <div class="col-md-4">
                                    <div class="single-room">
                                        <div class="room-img">
                                            <a href="/detail.php" data-toggle="modal" data-target="#roosui"><img src="images/room/room3.jpeg" style="width: 370px; height: 256px;" alt=""></a>
                                        </div>
                                        <div class="room-desc">
                                            <div class="room-name">
                                                <h3><a href="/detail.php" data-toggle="modal" data-target="#roosui">Suite </a></h3>
                                            </div>
                                            <div class="room-rent">
                                ...
                                <div class="col-md-4">
                                    <div class="single-room">
                                        <div class="room-img">
                                            <a href="/detail.php" data-toggle="modal" data-target="#rooclass"><img src="images/room/room2.jpg" style="width: 370px; height: 256px;" alt=""></a>
                                        </div>
                                        <div class="room-desc">
                                            <div class="room-name">
                                                <h3><a href="/detail.php" data-toggle="modal" data-target="#rooclass">Chambre Classique </a></h3>
                                            </div>
                                            <div class="room-rent">
            ...
            <div class="modal fade" style="margin-top: 100px;" id="rooclass" tabindex="-1" role="dialog" aria-labelledby="rooclass-label" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="rooclassTitle">NOS CHAMBRES CLASSIQUE</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                                    ...
                                    <div class="carousel-list">
                                        <div class="col-md-4">
                                            <div class="single-room">
                                                ...
                                                <div class="room-desc">
                                                    <div class="room-name">
                                                        <h3><a href="#" data-toggle="modal" data-target="#roovilla">CHAMBRE CLASSIQUE 1 </a></h3>
                                                    </div>
                                                    <div class="room-rent">
                                                        <h5>125 000 fcfa / <span>Jour en semaine</span></h5>
                                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="single-room">
                                                ...
                                                <div class="room-desc">
                                                    <div class="room-name">
                                                        <h3><a href="#" data-toggle="modal" data-target="#roosui">CHAMBRE CLASSIQUE 2 </a></h3>
                                                    </div>
                                                    <div class="room-rent">
                                                        <h5>150 000 fcfa / <span>Jour le weekend</span></h5>
                                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="single-room">
                                                ...
                                                <div class="room-desc">
                                                    <div class="room-name">
                                                        <h3><a href="#" data-toggle="modal" data-target="#rooclass">CHAMBRE CLASSIQUE 3 </a></h3>
                                                    </div>
                                                    <div class="room-rent">
                                                        <h5>65 000 fcfa / <span>Jour en semaine</span></h5>
                                        ...
                                        <div class="col-md-4">
                                            <div class="single-room">
                                                ...
                                                <div class="room-desc">
                                                    <div class="room-name">
                                                        <h3><a href="#" data-toggle="modal" data-target="#rooclass">CHAMBRE CLASSIQUE 4 </a></h3>
                                                    </div>
                                                    <div class="room-rent">
                                                        <h5>65 000 fcfa / <span>Jour en semaine</span></h5>
            ...
            <div class="modal fade" style="margin-top: 100px;" id="roosui" tabindex="-1" role="dialog" aria-labelledby="roosui-label" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="roosuiTitle">NOS SUITES</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
            ...
            <div class="modal fade" style="margin-top: 100px;" id="roovilla" tabindex="-1" role="dialog" aria-labelledby="roovilla-label" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="roovillaTitle">NOS VILLAS FAMILLES</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                                    ...
                                    <div class="carousel-list">
                                        <div class="col-md-4">
                                            <div class="single-room">
                                                ...
                                                <div class="room-desc">
                                                    <div class="room-name">
                                                        <h3><a href="#" data-toggle="modal" data-target="#roovilla">Villa famille 1 </a></h3>
                                                    </div>
                                                    <div class="room-rent">
                                                        <h5>125 000 fcfa / <span>Jour en semaine</span></h5>
                                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="single-room">
                                                ...
                                                <div class="room-desc">
                                                    <div class="room-name">
                                                        <h3><a href="#" data-toggle="modal" data-target="#roosui">Villa famille 2 </a></h3>
                                                    </div>
                                                    <div class="room-rent">
                                                        <h5>150 000 fcfa / <span>Jour le weekend</span></h5>
                                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="single-room">
                                                ...
                                                <div class="room-desc">
                                                    <div class="room-name">
                                                        <h3><a href="#" data-toggle="modal" data-target="#rooclass">Villa famille 3 </a></h3>
                                                    </div>
                                                    <div class="room-rent">
                                                        <h5>65 000 fcfa / <span>Jour en semaine</span></h5>
                                        ...
                                        <div class="col-md-4">
                                            <div class="single-room">
                                                ...
                                                <div class="room-desc">
                                                    <div class="room-name">
                                                        <h3><a href="#" data-toggle="modal" data-target="#rooclass">Villa famille 4 </a></h3>
                                                    </div>
                                                    <div class="room-rent">
                                                        <h5>65 000 fcfa / <span>Jour en semaine</span></h5>
