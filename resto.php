...
<body>
    ...
    <?php if (isset($_GET['lang']) && $_GET['lang'] == "en") { ?>
        ...
        <div class="wrapper">
            ...
            <div class="header-section about-us" style="background: url(images/bg/restook.gif) no-repeat; background-size: cover;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-title mb-80">
                                <h1 style="font-family: 'Reggae One', cursive;">The smile comes while eating</h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <p style="font-size: 20px; font-family:Crimson Pro, serif; line-height: 1.6; text-align: justify;">
                            "Villa BLANCA" <span style="text-transform: lowercase;"> serves a hearty breakfast to its guests. The hotel serves fresh meals cooked by our chef to give you tasting moment. </span></p>
                    </div>
                </div>
            </div>
            <!--About Section end-->
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="feature-desc text-left">
                                <div class="section-title mb-30">
                                    <h2>Villa blanca's <span style="color: rgb(226, 29, 29);">Restaurant</span></h2>
                                    <p>&nbsp;</p>
                                </div>
                                <div class="feature-item">
                                    <div class="btn-group" role="group" aria-label="button group">
                                        <a href="menuresto\menuresto.php?lang=en" role="button" class="btn btn-danger"><i class="fa fa-cutlery" aria-hidden="true"></i> See the menu</a>
                                        <a href="tel:+2250709660606" role="button" class="btn btn-success"><i class="fa fa-phone" aria-hidden="true"></i> Book</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="feature-img-tab">
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="feature1">
                                            <div class="feature-tab-inner">
                                                <img src="images/resto/resto1.jpg" alt="">
                                            </div>
                                        </div>
                                        <div role="tabpanel" class="tab-pane" id="feature2">
                                            <div class="feature-tab-inner">
                                                <img src="images/resto/resto2.jpg" alt="">
                                            </div>
                                        </div>
                                        <div role="tabpanel" class="tab-pane" id="feature3">
                                            <div class="feature-tab-inner">
                                                <img src="images/resto/resto5.jpeg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="feature-tab-item">
                                    <ul class="nav" role="tablist">
                                        <li class="active"><a href="#feature1" data-toggle="tab"><img src="images/resto/resto1.jpg" style="width: 166px; height: 147px;" alt=""></a></li>
                                        <li><a href="#feature2" data-toggle="tab"><img src="images/resto/resto2.jpg" style="width: 166px; height: 147px;" alt=""></a></li>
                                        <li><a href="#feature3" data-toggle="tab"><img src="images/resto/resto5.jpeg" style="width: 166px; height: 147px;" alt=""></a></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="feature-desc text-left">
                                <div class="section-title mb-30">
                                    <h2>Bar <span style="color: rgb(226, 29, 29);">villa blanca</span></h2>
                                    <p>&nbsp;</p>
                                </div>
                                <div class="feature-item">
                                    <div class="btn-group" role="group" aria-label="button group">
                                        <a href="#" role="button" class="btn btn-danger"><i class="fa fa-cutlery" aria-hidden="true"></i> See the menu</a>
                                        <a href="tel:+2250709660606" role="button" class="btn btn-success"><i class="fa fa-phone" aria-hidden="true"></i> Book</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="feature-img-tab">
                                <div class="feature-tab-desc">
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="feature3">
                                            <div class="feature-tab-inner">
                                                <img src="images/resto/resto3.jpeg" alt="">
                                            </div>
                                        </div>
                                        <div role="tabpanel" class="tab-pane" id="feature4">
                                            <div class="feature-tab-inner">
                                                <img src="images/resto/resto4.jpeg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="feature-tab-item">
                                    <ul class="nav" role="tablist">
                                        <li class="active"><a href="#feature3" data-toggle="tab"><img src="images/resto/resto3.jpeg" style="width: 166px; height: 147px;" alt=""></a></li>
                                        <li><a href="#feature4" data-toggle="tab"><img src="images/resto/resto4.jpeg" style="width: 166px; height: 147px;" alt=""></a>
                                        </li>
            ...
            <div class="about-section text-center ptb-80 white_bg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-title mb-80">
                                <h1 style="font-family: 'Reggae One', cursive;">Le sourire vient en mangeant</h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <p style="font-size: 20px; font-family:Crimson Pro, serif; line-height: 1.6; text-align: justify;">
                            "Villa BLANCA" <span style="text-transform: lowercase;"> sert un petit déjeuner copieux à ses convives. l’hôtel sert des repas frais confectionnés par notre chef pour vous faire
                                passer des temps de dégustation que vous apprécierez surement. </span></p>
                    </div>
                </div>
            </div>
            <!--About Section end-->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="feature-desc text-left">
                                <div class="section-title mb-30">
                                    <h2>Restaurant <span style="color: rgb(226, 29, 29);">villa blanca</span></h2>
                                    <p>&nbsp;</p>
                                </div>
                                <div class="feature-item">
                                    <div class="btn-group" role="group" aria-label="button group">
                                        <a href="menuresto\menuresto.php" role="button" class="btn btn-danger"><i class="fa fa-cutlery" aria-hidden="true"></i> Voir la carte</a>
                                        <a href="tel:+2250709660606" role="button" class="btn btn-success"><i class="fa fa-phone" aria-hidden="true"></i> Reservez</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="feature-desc text-left">
                                ...
                                <div class="feature-item">
                                    <div class="btn-group" role="group" aria-label="button group">
                                        <a href="#" role="button" class="btn btn-danger"><i class="fa fa-cutlery" aria-hidden="true"></i> Voir la carte</a>
                                        <a href="tel:+2250709660606" role="button" class="btn btn-success"><i class="fa fa-phone" aria-hidden="true"></i> Reservez</a>
                                    </div>
                                </div>
                            </div>
